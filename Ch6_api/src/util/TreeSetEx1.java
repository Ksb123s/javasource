...
public class TreeSetEx1 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("사자 보다 작은 값 :" + treeSet2.headSet("사자"));
    System.out.println("사자 보다 큰 값 :" + treeSet2.tailSet("사자"));
    System.out.println("사자 보다 작은 값 :" + treeSet2.lower("사자"));
    System.out.println("사자 보다 큰 값 :" + treeSet2.higher("사자"));
  }
}
